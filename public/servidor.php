...
// Función totalmente insegura. Yo la uso porque quiero servir correctamente a WASM sin apache
function obtenerMime($nombre)
{
...
if (!preg_match('/\.php$/', $requestedAbsoluteFile)) {
    header('Content-Type: ' . obtenerMime($requestedAbsoluteFile));
    header('Cross-Origin-Opener-Policy: same-origin');
    header('Cross-Origin-Embedder-Policy: require-corp');
    #printf("Es %s", obtenerMime($requestedAbsoluteFile));
